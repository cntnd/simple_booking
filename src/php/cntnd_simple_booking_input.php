...
<div class="form-vertical">
    ...
    <hr />
    <strong><?= mi18n("RESERVATION_TITLE") ?></strong>
    <div class="form-group">
        <div class="form-check form-check-inline">
    ...
    <div class="form-group">
        <div class="form-check form-check-inline">
            <input id="one_click" class="form-check-input" type="checkbox" name="CMS_VAR[8]" value="true" <?php if($one_click){ echo 'checked'; } ?> />
            <label for="one_click" class="form-check-label"><?= mi18n("ONE_CLICK_BOOKING") ?></label>
        </div>
    </div>
    <div class="form-group">
        <div class="form-check form-check-inline">
            <input id="show_past" class="form-check-input" type="checkbox" name="CMS_VAR[20]" value="true" <?php if($show_past){ echo 'checked'; } ?> />
            <label for="show_past" class="form-check-label"><?= mi18n("SHOW_PAST") ?></label>
        </div>

        <div class="form-check form-check-inline">
            <input id="show_past_admin" class="form-check-input" type="checkbox" name="CMS_VAR[21]" value="true" <?php if($show_past_admin){ echo 'checked'; } ?> />
            <label for="show_past_admin" class="form-check-label"><?= mi18n("SHOW_PAST_ADMIN") ?></label>
        </div>
    </div>
    <hr />
    <strong><?= mi18n("EMAIL_TITLE") ?></strong>
    <div class="form-group">
